...
# obj_list = [
#     Sphere(Point(0, 0, -1), 0.5, Lambertian(Color(0.8, 0.3, 0.3))),
#     Sphere(Point(0, -100.5, -1), 100, Lambertian(Color(0.8, 0.8, 0))),
#     Sphere(Point(-1, 0, -1), 0.5, Lambertian(Color(0.8, 0.8, 0.8))),
#     Sphere(Point(1, 0, -1), 0.5, Lambertian(Color(0.8, 0.6, 0.2)))
# ]
